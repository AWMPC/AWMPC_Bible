...
export function ReadingLocationControls({ book, chapter, visible, activeSection, onNavigate }: ReadingLocationControlsProps) {
  ...
  return (
    <nav className={`reading-location-controls${visible ? "" : " is-hidden"}`} aria-label="Reading location">
