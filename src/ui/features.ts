...
const FEATURES: readonly DockFeature[] = Object.freeze([
...
export const DOCK_FEATURES: readonly DockFeature[] = Object.freeze(FEATURES.filter((feature) => feature.id !== "navigation"));

export function featureTitle(id: FeatureId): string {
  return FEATURES.find((feature) => feature.id === id)?.shortLabel ?? "AWMPC Bible";
}
